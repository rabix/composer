...
export class JobEditorComponent implements OnChanges {
    ...
    private onJobFormChange(event: Event) {
        ...
        const formField = event.target as Element;
        ...
        const inputId = formField.getAttribute("inputID");
        ...
        const arrayIndex = formField.getAttribute("arrayIndex");
    ...
    private jobValueUpdate(inputId, jobValue) {
        ...
        this.statusBar.instant(`Updated job value of ${input.label || input.id}.`);
