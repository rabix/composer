...
import {SBDraft2CommandLineToolModel} from "cwlts/models/d2sb";

@Component({
    selector: "ct-tool-info",
    styleUrls: ["./tool-info.component.scss"],
    template: `
<div class="tool-info">
  <div class="tool-info-item tool-header">
    <h3>{{model.label}}</h3>
  ...
  <h3>Description:</h3>
  <div class="tool-info-item tool-description" [ct-markdown]="model.description"></div>
  <div class="tool-info-item tool-meta">
...
export class ToolInfoComponent implements OnChanges {
    @Input()
    ...
    ngOnChanges(changes: SimpleChanges) {
        ...
        this.categories = this.model.customProps['sbg:categories'] || null;
